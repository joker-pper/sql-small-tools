...
public class ReplaceTableExecuteParam extends BaseExecutorParam {
    ...
    /**
     * replace table execute 配置文件
     */
    @Parameter(names = {"-replace-table-execute"}, required = true, description = "replace table execute properties")
    private String replaceTableExecuteProperties;
